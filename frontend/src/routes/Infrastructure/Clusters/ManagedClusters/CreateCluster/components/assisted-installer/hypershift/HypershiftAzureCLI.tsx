  ...
  const listItems = [
      ...
      content: (
        <Fragment>
          <Content component={ContentVariants.p}>
            {t(
              'Install the Hosted Control Plane CLI, oc, az, and ccoctl. Authenticate with Azure (az login) and OpenShift (oc login).'
            )}
          </Content>
    ...
    },
    {
      ...
      content: (
        <Fragment>
          <Content component={ContentVariants.p}>
            {t('Set the required environment variables for your Azure hosted cluster deployment.')}
          </Content>
    ...
    },
    {
      ...
      content: (
        <Fragment>
          <Content component={ContentVariants.p}>
            {t(
              'Create an OIDC issuer for workload identity. This provisions Azure storage and signing keys required for the hosted cluster.'
            )}
          </Content>
          <CodeBlock actions={Actions(oidcCode, 'oidc-code')}>
            <CodeBlockCode id="oidc-code">{oidcCode}</CodeBlockCode>
          </CodeBlock>
        </Fragment>
      ),
    },
    {
      ...
      content: (
        <Fragment>
          <Content component={ContentVariants.p}>
            {t('Create the Azure workload identities required by the hosted cluster components.')}
          </Content>
    ...
    },
    {
      ...
      content: (
        <Fragment>
          <Content component={ContentVariants.p}>
            {t('Provision the Azure infrastructure components (VNet, subnets, NSGs) for the hosted cluster.')}
          </Content>
